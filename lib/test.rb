...
s=Song.create(name: "If a Had A Gun", artist_id: 1, album_id: 1, year: 2011, track: 1, duration: 123)
Album.create(name: "High Flying Birds")
Artist.create(name: "Noel Gallagher")
britpop = Genre.create(name: "Britpop")
s.genres << britpop

s2=Song.create(name: "The Death of You And Me", artist_id: 1, album_id: 1, year: 2011, track: 1, duration: 90)
rock = Genre.create(name: "Rock")
s2.genres << rock
s2.genres << britpop

s3=Song.create(name: "Paranoid", artist_id: 2, album_id: 2, year: 1978, track: 9, duration: 100)
Album.create(name: "Paranoid")
Artist.create(name: "Black Sabbath")
s3.genres << Genre.create(name: "Metal")
s3.genres << rock

s4=Song.create(name: "Stand By Me", artist_id: 3, album_id: 3, year: 2003, track: 4, duration: 180)
